...
function WeatherApp() {
    ...
    const fetchWeatherAPI = async () => {
        const APIurl = `https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=6eb404aa5cfdce082b8c969fdb85309e`;
                        //https://api.openweathermap.org/data/2.5/weather?q=${cityName}&appid=351b91eb5793839c83e289adb6f0acce;
